...
namespace SistemaGeneral
{
    public partial class Clientes : Form
    {
        ...
        {
            SqlDataAdapter dataAdapter = new SqlDataAdapter("SELECT TOP (100) PERCENT NCliente, ApeYNom, CUIT FROM ClientesBusqueda WHERE " + condicion + " ORDER BY NCliente", routines.Conectar());
        ...
        public void CargarCamposClientes()
        {
            ...
            else
            {
                ...
                tMail.Text = dataSet.Tables["clientes"].Rows[0]["EMailCliente"].ToString();
        ...
        private void cerrarSesiónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form1 F = new Form1();
            DialogResult opcion;
            opcion = MessageBox.Show("¿Desea cerrar la sesión?", "¡Atencion!", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
